...
def team_create(request):
    ...
    if request.method == 'POST':
        ...
        team_form = TeamForm(hunt=current_hunt)
...
def team_join(request, pk=None):
    ...
    if not join_code:
        ...
        return render(request, "team_registration.html", {"form": TeamForm(hunt=current_hunt), 'errors': error, 'current_hunt': current_hunt})
